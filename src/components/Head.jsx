  ...
  return (
    <>
      ...
      <div className="max-w-[800px]  w-full h-auto sm:h-screen mx-auto text-left flex flex-col justify-center px-4">
        ...
        {/* mobile */}
        <div className='flex sm:hidden h-screen items-center'>
          ...
          <div className='relative font-freestyle font-semibold text-[100px]'>
            ...
            <div className='text-[#292929] absolute top-[-10px] left-[40px] px-2 text-[45px] tracking-wide font-normal opacity-40'>and</div>
