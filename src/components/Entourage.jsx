        ...
        <section name='pamunuan' className="bg-[#f1f0e3] py-5 sm:py-10 font-sans">
            <div  className="container flex flex-col justify-center p-8 gap-10 mx-auto md:p-8 max-w-[1200px]">
                ...
                <div className='relative'>
                    <div className='text-[#4e4e4e] font-freestyle  text-left text-[55px] sm:text-[65px] leading-[63px] '>
                        Pamunuan
                    </div>
                ...
                <div className="grid gap-10 md:gap-8 px-8 sm:p-3 md:grid-cols-2 lg:px-12 xl:px-32">
                    ...
                    <div className="flex flex-col gap-2  items-center">
                        <h3 className=" text-3xl sm:text-4xl text-[#9f7648] text-center font-freestyle mb-2 sm:mb-3">Natatanging Ginoo</h3>
                        <div className="flex flex-col justify-center items-center">
                            <img src={tibor} alt=""
                    ...
                    <div className="flex flex-col justify-center items-center gap-2 sm:mt-20">
                        <h3 className=" text-3xl sm:text-4xl text-[#9f7648] text-center font-freestyle mb-2 sm:mb-3">Magulang ng Babaeng Ikakasal</h3>
                    ...
                    <div className="flex flex-col gap-2 justify-center items-center sm:mt-20">
                        <h3 className=" text-3xl sm:text-4xl text-[#9f7648] text-center font-freestyle mb-2 sm:mb-3">Magulang ng Lalaking Ikakasal</h3>
                    ...
                    <div className="flex flex-col gap-2  items-center sm:mt-20">
                        <div>
                            <h3 className=" text-3xl sm:text-4xl text-[#9f7648] text-center font-freestyle">Ninong at Ninang</h3>
                    ...
                    <div className="flex flex-col gap-2 justify-center items-center sm:mt-20">
                        <div>
                            <h3 className=" text-3xl sm:text-4xl text-[#9f7648] text-center font-freestyle">Ikalawang Pares</h3>
                        </div>
                        <div className="flex flex-col justify-center items-center ">
                            <div className="text-center ">
                                <div className="my-2 text-gray-600 text-base font-medium ">
